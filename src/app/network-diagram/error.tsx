...
export default function NetworkDiagramError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Network diagram error:', error);
  }, [error]);
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center gap-4 p-16 text-center">
        ...
        <h2 className="text-lg font-semibold">Diagram builder encountered an error</h2>
        <p className="max-w-md text-sm text-muted-foreground">
          Something went wrong with the diagram builder. Your saved diagrams are safe.
        </p>
        {error.message && (
