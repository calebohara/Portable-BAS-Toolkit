...
interface TerminalStore {
  ...
  // Session management
  createSession: (opts?: { host?: string; port?: number; baudRate?: BaudRate; label?: string }) => string;
...
function makeSession(opts?: { host?: string; port?: number; baudRate?: BaudRate; label?: string }): TerminalSession {
  return {
