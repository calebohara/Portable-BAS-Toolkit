...
| 53 | pin-security-definer-search-path.sql | Pins `search_path = public` on the 4 original SECURITY DEFINER helpers (`is_global_project_member`, `is_global_project_admin`, `join_global_project`, `auto_add_global_project_creator`) — SEC-2 | P (applied 2026-06-11, checker-verified) |
